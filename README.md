...
test_report — таблица с результатами
eedback_summary — анализ отзывов пользователей
issues.md — список найденных ошибок и предложений

Кратное описание:
Основое тестирование проводилось в терминале Docker и localhost:8080
Основные улучшения - добавленна более удобаная визуализация(сайт,о котором гвоворилось выше) и исправленны баги
